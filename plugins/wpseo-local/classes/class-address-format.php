		...
		public function get_address_format( $address_format, $address_details ) {
			...
			if ( in_array( $address_format, array(
				...
				if ( ! empty( $business_address ) ) {
					...
					if ( $use_tags ) {
						$output .= '<' . ( ( $oneline ) ? 'span' : 'div' ) . ' class="street-address" itemprop="streetAddress">';
				...
				if ( ! empty( $business_address ) ) {
					...
					if ( $use_tags ) {
						$output .= '<' . ( ( $oneline ) ? 'span' : 'div' ) . ' class="street-address" itemprop="streetAddress">' . $business_address . '</' . ( ( $oneline ) ? 'span' : 'div' ) . '>';
					}
					else {
						$output .= esc_html( $business_address );
					}
