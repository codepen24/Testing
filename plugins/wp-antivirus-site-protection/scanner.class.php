...
{
    public static  $scanner_version = '3.5';
    ...
    {
        $status = UploadSingleFile_Callback_extension($post_data);
        if ($status === false) $status = UploadSingleFile_Callback_extension($post_data, true);
