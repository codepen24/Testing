...
else if (file_exists(dirname(dirname(dirname(__FILE__))).'/siteguarding_logs/sgantivirus.login.keys.php')) include_once(dirname(dirname(dirname(__FILE__))).'/siteguarding_logs/sgantivirus.login.keys.php');
