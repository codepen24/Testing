...
add_action( 'admin_init', 'infusedwoo_add_jq_mobile', 10, 0 );
// Update Checker
add_filter( 'plugins_loaded', 'iw_admin_checks_update'); 
...
function infusedwoo_add_jq_mobile() {
		...
		<div class="infusedwoo-admin-wrapper">
			...
			<div class="infusedwoo-admin-left-menu">
				<div class="infusedwoo-admin-menu">
					...
					<ul><li><a href="#" class="menu-list-head">* GDPR Toolkit <span class='menu-new'>New</span></a>
							<ul>
