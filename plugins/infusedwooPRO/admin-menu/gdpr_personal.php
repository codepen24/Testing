...
<table width="100%">
	...
	<tr>
		<td width="200">
			<select multiple name="allfields" style="width: 100%; height: 300px; " class="allfields">
				<?php 
		...
		<td>
			<select multiple name="pfields" style="min-width: 100px; width: 100%; height: 300px;" class="pfields">
