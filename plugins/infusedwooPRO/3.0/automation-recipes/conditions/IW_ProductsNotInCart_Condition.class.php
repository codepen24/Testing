...
class IW_ProductsNotInCart_Condition extends IW_Automation_Condition {
	function get_title() {
		return 'If cart doesn\'t contain some product(s) ...';
	}
...
iw_add_condition_class('IW_ProductsNotInCart_Condition');