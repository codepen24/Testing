...
{
    $myavatar = get_template_directory_uri() . '/img/tcg.png';
    $avatar_defaults[$myavatar] = "TCG Avatar";
...
$labels = array(
	...
	'all_items'          => 'All Video Gallery',
	'view_item'          => 'View Video Gallery',
	'search_items'       => 'Search Video Gallery',
...
/**
 * Remove related products output by Fred
 */
...
/*
* Removing the InfusedWoo Custom Checkout Fields for Logged-in Users by Neil *
*/
if( is_user_logged_in() ) {
    function custom_override_checkout_fields( $iw_cf_checkrequired) {
    	unset( $fields[''][''] );
    	return $fields;
    }
