	...
	<?php while ( bp_members() ) : bp_the_member(); ?>
		...
		<li>
			...
			<div class="item">
				...
				<div>
					<?php 
					bp_member_profile_data( 'field=facebook' );
					?>
				</div>
			...
			<div class="action">
				<div class="bio">
					...
					<?php
					echo "<br>";
					echo "<b>" . __("Activity & Interest:", "boss-child") . "</b> ";
					$activities = xprofile_get_field_data(525, bp_get_member_user_id());
					$empty = true;
					if(!empty($activities)) {
						echo str_replace("Other", "", implode(", ", $activities));
						$empty = false;
					}
					$other_activities 	= xprofile_get_field_data(537, bp_get_member_user_id());
					if(!empty($other_activities)) {
						echo str_replace(",", ", ", $other_activities);
						$empty = false;
					}
					if($empty) {
						echo "-";
